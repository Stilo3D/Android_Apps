...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String KEY_EXTRA_ANSWER = "com.example.firstapp.correctAnswer";
    @SuppressLint("MissingInflatedId")
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Log.d("create", "onCreate executed");
        ...
        nextButton.setOnClickListener(v -> {currentIndex = (currentIndex + 1 ) % questions.length; answerWasShown = false; setNextQuestion();});
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        Log.d("save", "Method SAVEINSTANCESTATE executed");
